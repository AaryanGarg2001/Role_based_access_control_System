import { pgTable, uuid, varchar,timestamp,primaryKey, uniqueIndex,text } from "drizzle-orm/pg-core";
...
export const usersToRoles = pgTable("usersToRoles",{
    ...
    return{
        cpk:primaryKey(usersToRoles.applicationId,usersToRoles.userId,usersToRoles.roleId)
    }
});